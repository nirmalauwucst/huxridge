      ...
      <Section padding="lg" background="default">
        <Container size="narrow">
          ...
          <p className="text-muted-foreground mt-5 text-xl leading-relaxed">
            A 30-minute, no-obligation consultation with a Huxridge accountant.
            We will listen, assess your needs, and give you an honest view of
            how we can help — with no pressure to sign up.
          </p>
        </Container>
      </Section>
          ...
          <div className="grid gap-12 lg:grid-cols-5">
            ...
            <div className="lg:col-span-3">
              <div className="bg-background rounded-2xl border-2 border-dashed border-gray-300 p-10 text-center shadow-sm">
                <CalendarDays
                  className="text-primary-300 mx-auto mb-4 h-14 w-14"
                  aria-hidden="true"
                />
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  Select a date and time that suits you to speak with a member
                  of our team.
                </p>
                <div className="bg-secondary-50 text-secondary-500 mt-6 rounded-lg p-4 text-left text-xs">
                  <p className="text-secondary-600 font-medium">
                    Integration note:
                  </p>
                  <p className="mt-1">
                    Embed Cal.com booking widget using the{" "}
                    <code className="bg-secondary-100 rounded px-1">
                      @calcom/embed-react
                    </code>{" "}
                    package, configured with your Cal.com team link.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 lg:col-span-2">
              ...
              <div className="bg-background rounded-xl p-5 shadow-sm">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  30 minutes via video call or telephone
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-3 text-sm">
                  You do not need to prepare anything formal, but having these
                  to hand will make the conversation more productive:
                </p>
                <ul className="space-y-2">
                  {prepareNotes.map((note) => (
                    <li
                      key={note}
                      className="text-primary-800 flex items-start gap-2 text-sm"
                    >
              ...
              <div className="bg-primary-50 border-primary-100 rounded-xl border p-5">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  If you would rather speak directly, contact us through any of
                  the details below.
                </p>
                <div className="mt-4 space-y-2">
                  <a
                    href={`tel:${site.contact.phone}`}
                    className="text-primary-700 flex items-center gap-2 text-sm hover:underline"
                  >
