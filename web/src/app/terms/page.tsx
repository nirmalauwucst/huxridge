      ...
      <Container size="narrow">
        <div className="prose prose-slate prose-lg prose-headings:scroll-mt-24 prose-li:my-1.5 prose-p:leading-8 prose-ul:leading-8 prose-h2:mb-8 max-w-none">
          ...
          <p>
            ...
            confirm that you accept these Terms of Use and agree to comply with
            them. If you do not agree, you must not use the Site. These Terms
          ...
          <p>
            <strong>1.1</strong> These Terms of Use (&lsquo;Terms&rsquo;) govern
            your access to and use of the Site. We may revise these Terms at any
            time by amending this page &mdash; the date above shows when they
            were last updated.
          </p>
          <p>
          ...
          <p>
            ...
            amending this page. Your continued use of the Site after any change
            constitutes acceptance of the revised Terms.
          </p>
          <p>
            <strong>2.2</strong> We may update and change the Site from time to
            time to reflect changes to our services, our users&rsquo; needs, and
            our business priorities. We do not guarantee that the Site, or any
            content on it, will always be available or uninterrupted.
          </p>
          <p>
          ...
          <p>
            <strong>3.3</strong> You must not rely on any content on the Site as
            an alternative to professional advice.{" "}
          ...
          <p>
            ...
            on the basis of Site content, you should obtain professional advice
            specific to your circumstances. We accept no liability for any loss
            arising from reliance on Site content (see Clause 8).
          </p>
          ...
          <p>
            <strong>4.1</strong> You may use the Site only for lawful purposes.
            You must not:
          </p>
          <ul>
            <li>
            ...
            <li>
              use the Site in any way that is fraudulent, or has any fraudulent
              purpose or effect;
            </li>
            <li>
          ...
          <p>
            ...
            your access to the Site if you breach this clause, and to report any
          ...
          <p>
            ...
            &lsquo;Huxridge&rsquo; name and branding. These works are protected
            by copyright, trademark, and other laws.
          </p>
          <p>
            <strong>5.2</strong> You may view, download, and print extracts of
            Site content for your own personal, non-commercial use, provided you
            do not modify it and keep intact all copyright and proprietary
            notices.
          </p>
          <p>
          ...
          <p>
            <strong>5.4</strong> If you print, copy, or download any part of the
            Site in breach of these Terms, your right to use the Site will cease
            immediately and you must return or destroy any copies you have made.
          </p>
          ...
          <p>
            ...
            link, or reference on the Site does not constitute an endorsement by
            us of that third party, its products, or its services.
          </p>
          <p>
            <strong>6.3</strong> You may link to our home page, provided you do
            so in a way that is fair and legal and does not damage our
            reputation or take advantage of it. We reserve the right to withdraw
          ...
          <p>
            ...
            responsible for ensuring the information you provide is accurate. We
            will handle any personal data you submit in accordance with our{" "}
          ...
          <p>
            ...
            client relationship. We will respond to enquiries at our discretion.
          </p>
          <p>
          ...
          <p>
            <strong>8.2</strong> We exclude all implied conditions, warranties,
            representations, or other terms that may apply to the Site or any
            content on it, to the fullest extent permitted by law.
          </p>
          <p>
            <strong>8.3</strong> We will not be liable to any user for any loss
            or damage, whether in contract, tort (including negligence), breach
            of statutory duty, or otherwise, arising under or in connection with
            use of, or inability to use, the Site. In particular, we will not be
            liable for:
          </p>
          <ul>
          ...
          <p>
            ...
            configuring your own technology and using your own virus-protection
            software.
          </p>
          ...
          <p>
            <strong>9.1</strong> We process personal data collected through the
            Site in accordance with our{" "}
            <a href="/privacy-policy">Privacy Policy</a>, which explains what we
            collect, how we use it, and your rights under the UK General Data
            Protection Regulation (UK GDPR) and the Data Protection Act 2018.
          </p>
          <p>
            <strong>9.2</strong> The Site uses cookies and similar technologies.
            Details of the cookies we use and how you can manage them are set
          ...
          <p>
            <strong>10.2</strong> If any provision of these Terms is found to be
          ...
          <p>
            <strong>11.1</strong> This Site is operated by Huxridge Limited. To
            contact us:
          </p>
