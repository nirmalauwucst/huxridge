  ...
  return (
    <>
      ...
      <Section background="default" padding="sm">
        <Container size="narrow">
          <div
            className="guide-prose [&_h2]:text-primary-900 [&_h3]:text-primary-800 [&_h4]:text-primary-800 [&_p]:text-primary-800 [&_ul>li]:text-primary-800 [&_ol>li]:text-primary-800 [&_strong]:text-primary-900 [&_a]:text-primary-700 hover:[&_a]:text-primary-900 [&_blockquote]:border-accent-300 [&_blockquote]:text-primary-700 [&_hr]:border-border [&_th]:text-primary-900 [&_th]:border-border [&_td]:text-primary-800 [&_td]:border-border [&_a]:underline [&_a]:underline-offset-2 [&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:pl-4 [&_blockquote]:italic [&_em]:italic [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:text-xl [&_h3]:font-semibold [&_h4]:mt-6 [&_h4]:mb-2 [&_h4]:text-base [&_h4]:font-semibold [&_hr]:my-8 [&_ol]:mb-5 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol>li]:mb-2 [&_ol>li]:leading-relaxed [&_p]:mb-5 [&_p]:leading-relaxed [&_strong]:font-semibold [&_table]:mb-6 [&_table]:w-full [&_table]:border-collapse [&_td]:border-b [&_td]:py-2 [&_td]:text-sm [&_th]:border-b [&_th]:pb-2 [&_th]:text-left [&_th]:text-sm [&_th]:font-semibold [&_ul]:mb-5 [&_ul]:list-disc [&_ul]:pl-6 [&_ul>li]:mb-2 [&_ul>li]:leading-relaxed"
          ...
          <div className="border-border mt-12 border-t pt-8">
            <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
              ...
              professional advice. Your circumstances may differ — always
              consult a qualified accountant or tax adviser before taking
              action.
            </p>
