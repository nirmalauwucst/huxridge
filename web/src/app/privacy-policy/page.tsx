        ...
        <Container size="narrow">
          <div className="prose prose-slate prose-lg prose-headings:scroll-mt-24 prose-li:my-1.5 prose-p:leading-8 prose-ul:leading-8 prose-h2:mb-8 prose-h3:mb-4 max-w-none">
            ...
            <p>
              ...
              handle it in line with the UK General Data Protection Regulation
              (UK GDPR), the Data Protection Act 2018, the Privacy and
              Electronic Communications Regulations (PECR), and our professional
              and regulatory obligations as accountants.
            </p>
            ...
            <ul>
              ...
              <li>
                Bank account, payment, income, expenditure, and tax records
              </li>
              <li>Payroll, pension, and VAT information</li>
              <li>
                Company registration numbers, ownership, and details of
            ...
            <ul>
              <li>
                ...
                email or call us, or engage our services
              </li>
              <li>
            ...
            <p>
              ...
              do so. Depending on the circumstances, we rely on one or more of
              the following:
            </p>
            <ul>
              <li>
                <strong>Contractual necessity</strong> &ndash; to respond to
                your enquiry and to provide the services set out in our
                engagement letter
              </li>
              <li>
            ...
            <p>
              ...
              (for example as part of AML checks), we do so in accordance with
              the additional conditions set out in the Data Protection Act 2018.
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Analytics cookies</strong> &ndash; help us understand
                how visitors use our site so we can improve it (for example, web
                analytics tools)
              </li>
              <li>
            ...
            <p>
              ...
              non-essential cookies. You can accept, reject, or manage cookies
              at any time through our cookie banner or your browser settings.
            ...
            <ul>
              ...
              <li>
                Third-party accounting, payroll, and practice management
                software platforms
              </li>
            ...
            <p>
              ...
              place requiring them to keep your data secure and to process it
            ...
            <p>
              ...
              example by relying on adequacy regulations or appropriate
              safeguards such as the International Data Transfer Agreement or
            ...
            <p>
              ...
              the purposes for which it was collected, including to meet legal,
            ...
            <ul>
              ...
              <li>
                ...
                at least six years from the end of the relevant accounting
                period
              </li>
              <li>
                <strong>Anti-money laundering records</strong> &ndash; retained
                for five years after the end of our business relationship with
                you
              </li>
              <li>
            ...
            <ul>
              <li>
                <strong>Right of access</strong> &ndash; to request a copy of
                the personal data we hold about you
              </li>
              <li>
                <strong>Right to rectification</strong> &ndash; to have
                inaccurate or incomplete data corrected
              </li>
              <li>
                <strong>Right to erasure</strong> &ndash; to request deletion of
                your data, where there is no overriding legal reason to retain
                it
              </li>
              <li>
              ...
              <li>
                <strong>Right to data portability</strong> &ndash; to receive
            ...
            <p>
              ...
              details below. We will respond within one month. There is usually
              no charge, although we may charge a reasonable fee or refuse a
              request that is manifestly unfounded or excessive.
            </p>
            ...
            <p>
              ...
              include automated and AI-assisted tools, to help prepare and
              review your accounts and to deliver our services efficiently. We
              do not make decisions that produce legal or similarly significant
              effects about you based solely on automated processing without
            ...
            <p>
              ...
              privacy policy applies only to our website, and we are not
              responsible for the privacy practices of any third-party sites. We
              encourage you to read the privacy policy of any website you visit.
            </p>
            ...
            <p>
              ...
              please contact us in the first instance so we can try to resolve
              the matter. You also have the right to lodge a complaint with the
