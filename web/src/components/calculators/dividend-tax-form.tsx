...
export function DividendTaxForm() {
  ...
  useEffect(() => {
    trackEvent("calculator_viewed", {
      calculator_slug: "dividend-tax-calculator",
    });
  }, []);
      ...
      <div className="grid gap-8 lg:grid-cols-5">
        <div className="space-y-4 lg:col-span-2">
          {[
            {
              id: "dtf-other",
              label: "Other income (salary, rental, etc.)",
              helper: "Employment or other non-dividend income",
              value: otherIncome,
              set: setOtherIncome,
            },
            {
              ...
              helper: "Reduces your adjusted net income",
              value: pensionContributions,
              set: setPensionContributions,
            },
            {
              id: "dtf-dividends",
              label: "Dividend income",
              helper: "Gross dividends received or declared",
              value: dividendIncome,
              set: setDividendIncome,
            },
        ...
        >
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="border-border rounded-lg border bg-white p-3">
              ...
              <p className="text-primary-900 mt-0.5 text-lg font-semibold">
                {fmt(DIVIDENDS.allowance)}
              </p>
            </div>
            <div className="border-border rounded-lg border bg-white p-3">
